object FrmATTAdjustTeam: TFrmATTAdjustTeam
  Left = 0
  Top = 0
  Caption = #35843#29677#21333
  ClientHeight = 402
  ClientWidth = 725
  Color = clBtnFace
  ...
  object DBGrid2: TZSDDBGrid
    ...
    Columns = <
      ...
      item
        ...
        FieldName = 'NewTeam_'
        Title.Alignment = taCenter
        Title.Caption = #26032#29677#27425
        Visible = True
      end
      item
        Expanded = False
  ...
  object cdsViewb: TZSDDataSet
    ...
    object cdsViewbNewTeam_: TStringField
      FieldName = 'NewTeam_'
    end
    object cdsViewbStartDate_: TDateField
      FieldName = 'StartDate_'
    end
    object cdsViewbEndDate_: TDateField
      FieldName = 'EndDate_'
    end
  end
