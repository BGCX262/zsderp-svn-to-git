object FrmSalaryFixed: TFrmSalaryFixed
  Left = 0
  Top = 0
  Caption = #34218#36164#22266#23450#25187#34917#39033#32500#25252
  ClientHeight = 385
  ClientWidth = 725
  Color = clBtnFace
  ...
  object DBGrid1: TZSDDBGrid
    ...
    Columns = <
      ...
      item
        ...
        FieldName = 'MonthS_'
        Title.Alignment = taCenter
        Title.Caption = #24320#22987#24180#26376
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'MonthE_'
        Title.Alignment = taCenter
        Title.Caption = #32467#26463#24180#26376
        Visible = True
      end
      item
        Expanded = False
  ...
  object cdsView: TZSDDataSet
    ...
    object cdsViewMonthE_: TIntegerField
      FieldName = 'MonthE_'
    end
  end
